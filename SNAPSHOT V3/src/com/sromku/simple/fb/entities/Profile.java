...
public class Profile implements Serializable {
	...
	public Profile(GraphUser profile) {
	 ...
	 * @return
	 */
	public static Profile create(GraphUser user) {
	...
	public long getId() {
		if (getmGraphUser() != null)
			id = Long.valueOf(getmGraphUser().getId());
		return id;
	}
	...
	public String getGender() {
		if (getmGraphUser() != null)
			gender = String.valueOf(getmGraphUser().getProperty(Properties.GENDER));
		return gender;
	}
	...
	public String getLocale() {
		if (getmGraphUser() != null)
			locale = String.valueOf(getmGraphUser().getProperty(Properties.LOCALE));
		return locale;
	}
	...
	public List<Language> getLanguages() {
		if (getmGraphUser() != null) {
			...
			JSONArray jsonArray = (JSONArray) getmGraphUser()
					.getProperty(Properties.LANGUAGE);
			if (jsonArray != null) {
	...
	public String getAgeRange() {
		if (getmGraphUser() != null) {
			JSONObject jsonObject = (JSONObject) getmGraphUser()
					.getProperty(Properties.AGE_RANGE);
	...
	public String getThirdPartyId() {
		if (getmGraphUser() != null) {
			Object property = getmGraphUser().getProperty(Properties.THIRD_PARTY_ID);
	...
	public boolean getInstalled() {
		if (getmGraphUser() != null) {
			installed = (Boolean) getmGraphUser().asMap().get(Properties.INSTALLED);
		}
		return installed;
	}
	...
	public String getUpdatedTime() {
		if (getmGraphUser() != null) {
			updatedTime = String.valueOf(getmGraphUser()
					.getProperty(Properties.UPDATED_TIME));
		}
		return updatedTime;
	}
	...
	public Boolean getVerified() {
		if (getmGraphUser() != null) {
			verified = (Boolean) getmGraphUser().asMap().get(Properties.INSTALLED);
		}
		return verified;
	}
	...
	public String getCurrency() {
		if (getmGraphUser() != null) {
			JSONObject jsonObject = (JSONObject) getmGraphUser()
					.getProperty(Properties.CURRENCY);
			if (jsonObject != null) {
	...
	public String getEmail() {
		if (getmGraphUser() != null) {
			email = String.valueOf(getmGraphUser().getProperty(Properties.EMAIL));
		}
		return email;
	}
	...
	public String getHometown() {
		if (getmGraphUser() != null) {
			hometown = String.valueOf(getmGraphUser()
					.getProperty(Properties.HOMETOWN));
		}
		return hometown;
	}
	...
	public String getPolitical() {
		if (getmGraphUser() != null) {
			political = String.valueOf(getmGraphUser()
					.getProperty(Properties.POLITICAL));
		}
		return political;
	}
	...
	public List<String> getFavoriteTeams() {
		if (getmGraphUser() != null) {
			...
			JSONArray jsonArray = (JSONArray) getmGraphUser()
					.getProperty(Properties.FAVORITE_TEAMS);
			if (jsonArray != null) {
				for (int i = 0; i < jsonArray.length(); i++) {
					JSONObject jsonObject = jsonArray.optJSONObject(i);
					if (jsonObject != null) {
	...
	public String getPicture() {
		if (getmGraphUser() != null) {
			JSONObject result = (JSONObject) getmGraphUser()
					.getProperty(Properties.PICTURE);
	...
	public String getQuotes() {
		if (getmGraphUser() != null) {
			quotes = String.valueOf(getmGraphUser().getProperty(Properties.QUOTES));
		}
		return quotes;
	}
	...
	public String getRelationshipStatus() {
		if (getmGraphUser() != null) {
			relationshipStatus = String.valueOf(getmGraphUser()
	...
	public String getReligion() {
		if (getmGraphUser() != null) {
			religion = String.valueOf(getmGraphUser()
					.getProperty(Properties.RELIGION));
		}
		return religion;
	}
	...
	public String getWebsite() {
		if (getmGraphUser() != null) {
			website = String
					.valueOf(getmGraphUser().getProperty(Properties.WEBSITE));
		}
		return website;
	}
