...
public class MainActivity extends Activity {
	...
	@ViewById(R.id.button_publish_feed)
	public Button mButtonPublishFeed;
	@ViewById(R.id.button_publish_story)
	public Button mButtonPublishStory;
	@ViewById(R.id.button_publish_photo)
	public Button mButtonPublishPhoto;
	@ViewById(R.id.button_invite_all)
	public Button mButtonInviteAll;
	@ViewById(R.id.button_invite_suggested)
	public Button mButtonInviteSuggested;
	@ViewById(R.id.button_invite_one)
	public Button mButtonInviteOne;
	@ViewById(R.id.button_get_profile)
	public Button mButtonGetProfile;
	@ViewById(R.id.button_get_profile_with_properties)
	public Button mButtonGetProfileProperties;
	@ViewById(R.id.button_get_friends)
	public Button mButtonGetFriends;
	@ViewById(R.id.button_get_albums)
	public Button mButtonGetAlbums;
	@ViewById(R.id.button_fragments)
	public Button mButtonFragments;
	...
	@Extra
	public String nameSpace = "devmixsnapshot";
			...
			public void onClick(View v) {
				...
				mSimpleFacebook.publish(photo, new OnPublishListener() {
					...
					public void onComplete(String id) {
						hideDialog();
						toast("Published successfully. The new image id = "
								+ id);
					}
				});
			}
	...
	private void inviteExamples() {
		...
		mButtonInviteAll.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				mSimpleFacebook.invite("I invite you to use this app",
						onInviteListener);
			}
		});
		...
		mButtonInviteSuggested.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				String[] friends = new String[] { "630243197", "584419361",
						"1456233371", "100000490891462" };
		...
		final OnProfileRequestListener onProfileRequestListener = new SimpleFacebook.OnProfileRequestListener() {
			...
			public void onComplete(Profile profile) {
				...
				AlertDialog dialog = Utils
						.buildProfileResultDialog(MainActivity.this,
								new Pair<String, String>(Properties.ID, id),
								new Pair<String, String>(Properties.FIRST_NAME,
										firstName), new Pair<String, String>(
										Properties.COVER, coverUrl),
								new Pair<String, String>(Properties.PICTURE,
										pictureUrl));
				dialog.show();
			}
		};
