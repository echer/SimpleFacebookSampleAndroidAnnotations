...
@EBean
public class ConfiguracoesManager implements DataBaseActionsThrows{
	...
	public Configuracoes loadFirst() throws Exception{
		return daoConfiguracoes.queryForFirst(daoConfiguracoes.queryBuilder().prepare());
	}
